...
(function() {
  ...
  function updateOptions() {
    ...
    let options = [];
    if (service === "graphic") {
      options = ["Logo Design", "Brand Identity", "Banner Design", "Poster", "Brochure", "Packaging"];
    } else if (service === "web") {
      options = ["Portfolio Website", "Business Website", "E-commerce", "Landing Page"];
    }

    let defaultOption = document.createElement("option");
    defaultOption.text = "-- Choose an Option --";
    defaultOption.value = "";
    subService.appendChild(defaultOption);
  ...
  form.addEventListener("submit", function (e) {
    ...
    fetch(form.action, {
      ...
      .catch(error => {
        messageBox.innerHTML = "Network error. Try again later.";
        messageBox.classList.add("error");
      })
      .finally(() => {
